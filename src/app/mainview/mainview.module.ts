...
@NgModule({
  ...
  declarations: [ MapviewComponent, BasemapsComponent, LayersComponent, SiglLegendComponent ],
  exports: [ MapviewComponent, BasemapsComponent,LayersComponent, SiglLegendComponent ]
})
